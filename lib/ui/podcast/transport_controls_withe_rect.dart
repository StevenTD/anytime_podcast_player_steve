...
class PlayControlWithRect extends StatelessWidget {
  final Episode episode;
  final double? iconSize;

  const PlayControlWithRect({super.key, required this.episode, this.iconSize});
...
class RectContainer extends StatelessWidget {
  Widget control;
  final Episode episode;
  RectContainer({super.key, required this.control, required this.episode});
    ...
    return ClipRRect(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(10.0), // Ensure the same radius
        ),
        child: Semantics(
          container: true,
          child: Row(
            children: [
              ...
              Text((episode.duration / 60).round().toString() + ' min')
            ],
          ),
        ),
      ),
