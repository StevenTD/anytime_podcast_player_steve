...
class EpisodeTileMoreDetails extends StatefulWidget {
  ...
  @override
  State<EpisodeTileMoreDetails> createState() => _EpisodeTileState();
}

class _EpisodeTileState extends State<EpisodeTileMoreDetails> {
  bool expanded = false;
