...
This is the official repository for the Anytime Podcast Player - the simple Podcast playing app for Android & iOS with dyanmic color support and familiar interface, built with Dart & Flutter.
***
Latest build status
